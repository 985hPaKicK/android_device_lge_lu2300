...
#define AUDIO_SET_MODE	_IOW(AUDIO_IOCTL_MAGIC, 99, unsigned)
#define AUDIO_MODE_CALL		1
#define AUDIO_MODE_SOUND	0
...
#define HEADSET_SPKR_STEREO_VOIP	0x26
#define HEADSET_MIC_VOIP			0x27

#define HANDSET_SPKR_VOIP			0x28
#define HANDSET_MIC_VOIP			0x29

#define SPKR_PHONE_STEREO_VOIP		0x2B
#define SPKR_PHONE_MIC_VOIP			0x2C


#define SPKR_PHONE_REC_MIC 0x2E


#define	AUX_HEADSET_MASK	      (0x30)
#define	AUX_HEADSET_MIC         (AUX_HEADSET_MASK|HEADSET_MIC)
#define	AUX_HEADSET_SPKR_MONO   (AUX_HEADSET_MASK|HEADSET_SPKR_MONO)
#define	AUX_HEADSET_SPKR_STEREO (AUX_HEADSET_MASK|HEADSET_SPKR_STEREO)

#define	AUX_HEADSET_PLUS_SPKR_MASK	     		 	(0x40)
#define	AUX_HEADSET_MONO_PLUS_SPKR_MONO_RX          (AUX_HEADSET_PLUS_SPKR_MASK|HEADSET_SPKR_MONO)
#define	AUX_HEADSET_MONO_PLUS_SPKR_STEREO_RX   		(AUX_HEADSET_PLUS_SPKR_MASK|HEADSET_SPKR_STEREO)

#define	AUX_HEADSET_PLUS_HEADSET_MASK	     		 		(0x80)
#define	AUX_HEADSET_MONO_PLUS_HEADSET_MONO_SPKR_RX          (AUX_HEADSET_PLUS_HEADSET_MASK|HEADSET_SPKR_MONO)
#define	AUX_HEADSET_MONO_PLUS_HEADSET_STEREO_SPKR_RX   		(AUX_HEADSET_PLUS_HEADSET_MASK|HEADSET_SPKR_STEREO)

#define	BOTH_HEADSET_PLUS_SPKR_MASK	     		 			(0x100)
#define	BOTH_HEADSET_MONO_PLUS_SPKR_MONO_RX          		(BOTH_HEADSET_PLUS_SPKR_MASK|HEADSET_SPKR_MONO)
#define	BOTH_HEADSET_MONO_PLUS_SPKR_STEREO_RX   			(BOTH_HEADSET_PLUS_SPKR_MASK|HEADSET_SPKR_STEREO)
