...
/*CAMERA_SET_PARM_CHECK_AF_DONE,
CAMERA_SET_PARM_FOCUS_MODE,
CAMERA_SET_PARM_MANUAL_FOCUS_STEP,
CAMERA_SET_PARM_FOCUS_LOCATION,
CAMERA_SET_PARM_TAKE_PIC_TIME,
CAMERA_SET_GPS_INFO,
CAMERA_SET_PARM_TAKEPIC_MODE,*/
    CAMERA_SET_PARM_WB,
    ...
    CAMERA_SET_PARM_HJR,
    CAMERA_SET_PARM_ROLLOFF=55,
    CAMERA_STOP_PREVIEW=56,
    CAMERA_START_PREVIEW,
    CAMERA_START_SNAPSHOT=60,
    CAMERA_START_VIDEO=59,
    CAMERA_STOP_SNAPSHOT=58,
    CAMERA_EXIT=61,
    CAMERA_STOP_VIDEO,
...
/*CAMERA_GET_PARM_JPG_IMAGE_SIZE,
CAMERA_SET_PARM_IMAGE_QUALITY,
CAMERA_SET_PARM_ANTI_SHAKING,
CAMERA_SET_PARM_BLINK_DETECTION,
CAMERA_SET_PARM_SMILE_DETECTION,
CAMERA_SET_PARM_NIGHT_MODE,
CAMERA_SET_PARM_AUTO_MODE,
CAMERA_SET_PARM_ORIENTATION,
CAMERA_GET_PARM_ASD_MODE,*/
};
